...
$(function () {
    ...
    perform = {
        ...
        getForms: function (submit) {
            var tata = submit.attr('data-perform-forms');
            if (perform.verbose && (!tata || tata === undefined)) console.error("No data-perform-forms attribute is present.");
            return tata ? tata.split(perform.splitchar) : [];
        },
        getEvents: function (submit) {
            var tata = submit.attr('data-perform-events');
            if (perform.verbose && (!tata || tata === undefined)) console.error("No data-perform-events attribute is present.");
            return tata ? tata.split(perform.splitchar) : [];
        },
        ...
        getMethods: function (submit) {
            var tata = submit.attr('data-perform-methods');
           if (perform.verbose && (!tata || tata === undefined)) console.error("No data-perform-methods attribute is present.");
            return tata ? tata.split(perform.splitchar) : [];
        },
